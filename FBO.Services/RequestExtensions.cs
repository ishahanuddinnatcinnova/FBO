...
namespace FBO.Services
{
    public static class RequestExtensions
    {
        ...
        public static bool IsMobileBrowser(this IHttpContextAccessor request)
        {
            var userAgent = request.HttpContext.Request.UserAgent();
        ...
        public static string GetIpAddress(this IHttpContextAccessor accessor)
        {
            if (!string.IsNullOrEmpty(accessor.HttpContext.Request.Headers["CF-CONNECTING-IP"]))
                return accessor.HttpContext.Request.Headers["CF-CONNECTING-IP"].ToString();
